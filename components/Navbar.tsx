...
const Navbar = () => {
  ...
  return (
    <nav className="border-b border-b-purple-300/5 shadow-[0_4px_20px_-10px] shadow-purple-200/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Dekstop Navigation and Mobile Menu Icon */}
        ...
        <div className="md:hidden fixed inset-0 z-40">
          ...
          <div
            className={`absolute top-16 left-0 right-0 border-b border--300/5 shadow-lg transition-all duration-300 ease-in-out ${
              isOpen
